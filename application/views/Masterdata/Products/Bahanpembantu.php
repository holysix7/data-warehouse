                ...
                <!-- End of Topbar -->
                 <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Data Bahan Pembantu</h1>
                    </div>
                              ...
                              <?php $index = 1; foreach($data as $row){ ?>
                                <tr>
                                  ...
                                  <td class="text-center">
                                    ...
                                    <a onclick="return confirm('Hapus data ini ?')" href="<?php echo base_url("bahan-pembantu/delete/".$row['id']) ?>" data-toggle="tooltip" title="Hapus" class="btn btn-danger">
        ...
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form action="<?php echo base_url('bahan-pembantu/add'); ?>" method="POST">
    ...
    <div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form action="<?php echo base_url('bahan-pembantu/update'); ?>" method="POST">
                <div class="form-group">
                  <label>Kode Produk </label>
