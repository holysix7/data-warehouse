                ...
                <!-- End of Topbar -->
                 <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Barang Stok dan Non Stok</h1>
                    </div>
                              ...
                              <?php $index = 1; foreach($data as $row){ ?>
                                <tr>
                                  ...
                                  <td class="text-center">
                                    ...
                                    <a onclick="return confirm('Hapus data ini ?')" href="<?php echo base_url("products/delete/".$row['id']) ?>" data-toggle="tooltip" title="Hapus" class="btn btn-danger">
