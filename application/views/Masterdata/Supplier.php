...
<body id="page-top">
            ...
            <div class="modal-body">
              <form action="<?php echo base_url('supplier/add'); ?>" method="POST">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="phone" class="form-control" placeholder="Nama Supplier" required>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <TextArea class="form-control" name="notes" placeholder="Alamat Supplier"></TextArea>
                </div>
              <hr>
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form action="<?php echo base_url('supplier/update'); ?>" method="POST">
                ...
                <div class="form-group">
                  <label>No Telepon </label>
                  <input type="text" name="phone" id="e_phone" class="form-control" placeholder="Nama Supplier" required>
                </div>
                <div class="form-group">
                  <label>Alamat Supplier </label>
                ...
                <div class="form-group">
                  <label>Keterangan </label>
                  <TextArea class="form-control" name="notes" id="e_notes" placeholder="Alamat Supplier"></TextArea>
                </div>
              <hr>
              <div class="text-right">
                <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
    ...
    <script type="text/javascript">
      function edit(id, supplier_code, supplier_name, phone, supplier_address, notes){
        $('#e_id').val(id);
